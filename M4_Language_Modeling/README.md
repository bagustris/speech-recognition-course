...
<!-- $$
\hat{P}\left( w_k \mid w_1 \ldots w_{k - 1} \right) = \lambda \hat{P}_1\left( w_k \mid w_1 \ldots w_{k - 1} \right) + (1 - \lambda) \hat{P}_2\left( w_k \mid w_1 \ldots w_{k - 1} \right)
$$ -->
